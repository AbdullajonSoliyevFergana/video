				...
				<div class="container-fluid position-relative">
					<div class="row">
                        <div class="col-7 col-md-4">
                            <a href="components/layout.blade.php" class="tm-bg-black text-center tm-logo-container">
                                ...
                                <nav class="navbar navbar-expand-lg mr-0 ml-auto" id="tm-main-nav">
                                    ...
                                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                                        <ul class="navbar-nav text-uppercase">
                                            <li class="nav-item">
                                                <a class="nav-link tm-nav-link" href="components/layout.blade.php">Videos</a>
                                            </li>
                                            <li class="nav-item active">
                                                <a class="nav-link tm-nav-link" href="about.blade.php">About <span class="sr-only">(current)</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link tm-nav-link" href="contact.blade.php">Contact</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
